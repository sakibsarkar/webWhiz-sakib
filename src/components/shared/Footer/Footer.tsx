        ...
        <footer className="bg-[#0E1025] min-h-[453px]">
            <div className="container spacing pt-[32px] col-center flex flex-col items-center justify-between gap-[42px]">
                <div className="flex flex-col items-start justify-start gap-[62px] w-full">
                    <div className="w-full flex flex-col justify-between items-center md:flex-row gap-[16px]">
                        <div className="text-white text-[32px] relative">
                            ...
                            <h1 className="text-[20px] sm:text-[28px] lg:text-[32px] font-[700] "><span className="footHighlight">Subscribe</span> for newsletter</h1>
                            <div className="center border-[3.11px] border-[#FBA017] w-[28px] h-[28px] rounded-[50%] absolute right-[-45px] top-[20px] sm:top-[35px]">
                                <StarIcon />
                            </div>
                        </div>

                        <div className="flex justify-between w-[295px] h-[46px] border-[1px] border-[#ffffff33] rounded-full  pl-[16px] md:w-[304px]  lg:w-[370px]">
                    ...
                    <div className="flex gap-[133px] items-start w-full flex-wrap lg:flex-nowrap">
                        ...
                        <div className="w-full flex flex-row justify-between items-start lg:justify-start gap-[16px] lg:flex-col lg:w-auto flex-wrap">
                        ...
                        <div className="flex flex-col justify-between items-start text-white w-full gap-[70px] flex-wrap sm:flex-row">
